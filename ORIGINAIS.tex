...
\noindent{}{\footnotesize\emph{Fonte: Câmara dos Deputados Brasileira \& Congreso Nacional Espanhol.}}
...
\noindent{}{\footnotesize\emph{Fonte: Elaboração própria.}}
...
\noindent{}{\footnotesize\emph{Fonte: Melo (2011) e autores.}}
...
\noindent{}{\footnotesize\emph{Fonte: Elaboração dos autores.}}
...
tecnossociais, \emph{por Vera Chaia (\textsc{puc}/\textsc{sp}), Rosemary Segurado (\textsc{puc}/\textsc{sp}), Tathiana
Chicarino (\textsc{puc}/\textsc{sp}) e Joyce Miranda Leão Martins}}
...
\addcontentsline{toc}{chapter}{Participação cidadã e o uso das Tecnologias de Informação e Comunicação pela \textsc{abong}, \emph{por Claudio Luis de Camargo Penteado, Marcelo Burgos Pimentel
...
\begin{center}
Quadro 1: descrição dos projetos em execução pela \textsc{abong}
\end{center}
...
\noindent{}{\footnotesize\emph{Tabela elaborada pelos autores, 2019.}}
...
\tit{Associação Brasileira das Organizações Não"-Governamentais; Observatório
...
\emph{papers} apresentados no grupo de trabalho da \textsc{anpocs}, \emph{por Rafael Cardoso Sampaio, Isabele Mitozo, Michele Goulart Massuchin, Giulia Sbaraini Fontes e Cláudio Luis de Camargo Penteado}}
...
\noindent{}{\footnotesize\emph{Fonte: Elaboração própria, 2017.}}
