...
\begin{center}
\textls[-5]{Gráfico 1: Estratégias de comunicação \emph{offline} dos partidos brasileiros e
...
e \emph{offline}, na Espanha essa associação positiva só ocorre com a variável
...
\tit{stromer}-\textsc{galley}, J. Interação \emph{\emph{online}} e por que os candidatos a evitam.
...
\tit{vaccari}, Christian. (2012), Comparing \emph{\emph{online}} politics: Parties' and
...
\tit{lilliker}, G \& \textsc{michalska}, Karolina Koc (2011) ``\textsc{mep}s \emph{\emph{online}}:
...
\tit{panagopoulos}, Costas. (2009) \emph{Politicking \emph{\emph{online}} -- the
...
\noindent{}Duas questões são importantes para o entendimento das juventudes
...
Os dispositivos móveis de comunicação e as redes sociais \emph{\emph{online}} estão no
...
colaborativas em prol de \emph{\emph{\emph{software}}s} abertos, Internet livre e
...
A aposta na comunicação \emph{\emph{\emph{online}}} impediu, segundo parte dos
...
\section{A mola reprimida do \textsc{mbl}}
...
sobre democracia digital, governo aberto, campanhas políticas \emph{offline} e
...
\noindent{}A área de pesquisa de Ciberpolítica, Ciberativismo e Cibercultura se
...
\begin{tabular}[c]{@{}l@{}}Open source, \emph{\emph{software}}\\ livre e dados abertos\end{tabular} & 4 & 3,8 \\ \hline
Mídia & 3 & 2,8 \\ \hline
Blogs & 3 & 2,8 \\ \hline
...
\emph{chats} e \emph{\emph{\emph{software}}} livre, por exemplo, não ganham tanto
